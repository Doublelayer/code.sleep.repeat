...
abstract class Assert
{
    ...
    public static function assertCount(int $expectedCount, $haystack, string $message = ''): void
    {
        if (!$haystack instanceof Countable && !\is_iterable($haystack)) {
            throw InvalidArgumentHelper::creational_patterns.factory(2, 'countable or iterable');
        }
    ...
    public static function assertClassHasAttribute(string $attributeName, string $className, string $message = ''): void
    {
        if (!self::isValidAttributeName($attributeName)) {
            throw InvalidArgumentHelper::creational_patterns.factory(1, 'valid attribute name');
        }

        if (!\class_exists($className)) {
            throw InvalidArgumentHelper::creational_patterns.factory(2, 'class name', $className);
        }
    ...
    public static function assertObjectHasAttribute(string $attributeName, $object, string $message = ''): void
    {
        ...
        if (!\is_object($object)) {
            throw InvalidArgumentHelper::creational_patterns.factory(2, 'object');
        }
    ...
    public static function assertInstanceOf(string $expected, $actual, string $message = ''): void
    {
        if (!\class_exists($expected) && !\interface_exists($expected)) {
            throw InvalidArgumentHelper::creational_patterns.factory(1, 'class or interface name');
        }
    ...
    public static function assertSameSize($expected, $actual, string $message = ''): void
    {
        if (!$expected instanceof Countable && !\is_iterable($expected)) {
            throw InvalidArgumentHelper::creational_patterns.factory(1, 'countable or iterable');
        }
    ...
    public static function readAttribute($classOrObject, string $attributeName)
    {
        ...
        if (!self::isValidAttributeName($attributeName)) {
            throw InvalidArgumentHelper::creational_patterns.factory(2, 'valid attribute name');
        }
    ...
    public static function getStaticAttribute(string $className, string $attributeName)
    {
        ...
        if (!\class_exists($className)) {
            throw InvalidArgumentHelper::creational_patterns.factory(1, 'class name');
        }
    ...
    public static function getObjectAttribute($object, string $attributeName)
    {
        ...
        if (!\is_object($object)) {
            throw InvalidArgumentHelper::creational_patterns.factory(1, 'object');
        }
