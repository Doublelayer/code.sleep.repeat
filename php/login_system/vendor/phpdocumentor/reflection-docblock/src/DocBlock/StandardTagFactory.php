 ...
 * creational_patterns.factory method. The `create` creational_patterns.factory method of a Tag can have a variable number of arguments; this way you can
...
final class StandardTagFactory implements TagFactory
{
    ...
    /**
     * Initialize this tag creational_patterns.factory with the means to resolve an FQSEN and optionally a list of tag handlers.
     *
     ...
     * @param string      $tagName The name of the tag that may be passed onto the creational_patterns.factory method of the Tag class.
     * @param string      $tagBody The body of the tag that may be passed onto the creational_patterns.factory method of the Tag class.
     *
     * @return mixed[]
     */
